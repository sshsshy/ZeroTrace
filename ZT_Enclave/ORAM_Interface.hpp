...
*/
	...
	class ORAM_Interface
	{
		...
		//virtual void Create()=0;
	    	virtual void Create(uint8_t pZ, uint32_t max_blocks, uint32_t data_size, uint32_t stash_size, uint32_t oblivious_flag, uint32_t recursion_data_size, uint8_t recursion_levels) = 0;
