...
*/
  ...
  enum PATHORAM_TIMER {PO_POSMAP_START, PO_POSMAP_END, PO_FETCH_BLOCK_START, PO_FETCH_BLOCK_END,
 PO_EVICTION_LOGIC_START, PO_EVICTION_LOGIC_END, PO_UPLOAD_PATH_START, PO_UPLOAD_PATH_END};
 
  enum CIRCUITORAM_TIMER {CO_POSMAP_START, CO_POSMAP_END, CO_FETCH_BLOCK_START, CO_FETCH_BLOCK_END,
   CO_EVICTION_LOGIC_1_START, CO_EVICTION_LOGIC_1_END, CO_UPLOAD_PATH_1_START, CO_UPLOAD_PATH_1_END,
   CO_EVICTION_LOGIC_2_START, CO_EVICTION_LOGIC_2_END, CO_UPLOAD_PATH_2_START, CO_UPLOAD_PATH_2_END}; 
